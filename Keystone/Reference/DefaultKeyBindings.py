...
SAVE_COMMAND = "bind_save_file"
LOAD_COMMAND = "bind_load_file"

DEFAULT_BIND= "1 \"powexec_slot 1\""
DEFAULT_LOAD_BIND ="SHIFT+NUMPAD0 bind_load_file_silent \"%s\"$$em I just loaded a keybind file made with Keystone and didn't change this message!"
